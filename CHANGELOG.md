...
- New tab page with Calder branding and dev port quick links
...
- External CLI sessions triggering notifications from Calder
...
- CLI launcher for npm global install (npm i -g calder)
...
- .calderignore for AI readiness large-file scan exclusions
- AI readiness scanner with auto-created .calderignore for large-file exclusions
