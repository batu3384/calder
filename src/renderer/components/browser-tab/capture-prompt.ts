...
export function escapePromptLiteral(
  value: string,
  maxLength = DEFAULT_PROMPT_LITERAL_MAX_LENGTH,
): string {
  const truncated =
...
export function sanitizePromptBody(
  value: string,
  maxLength = DEFAULT_PROMPT_BODY_MAX_LENGTH,
): string {
