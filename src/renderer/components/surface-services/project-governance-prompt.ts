...
export const appendProjectGovernanceToPrompt: ProjectGovernancePromptModule["appendProjectGovernanceToPrompt"] = (...args) =>
  projectGovernancePrompt.appendProjectGovernanceToPrompt(...args);
