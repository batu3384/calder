...
export const getStatus: SessionActivityModule['getStatus'] = (...args) =>
  sessionActivity.getStatus(...args);
export const onChange: SessionActivityModule['onChange'] = (...args) =>
  sessionActivity.onChange(...args);
export const initSession: SessionActivityModule['initSession'] = (...args) =>
