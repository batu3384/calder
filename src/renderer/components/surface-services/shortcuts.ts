...
export const displayKeys: ShortcutsModule["displayKeys"] = (...args) => shortcuts.displayKeys(...args);
export const eventToAccelerator: ShortcutsModule["eventToAccelerator"] = (...args) => shortcuts.eventToAccelerator(...args);
