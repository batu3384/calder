...
interface ShareDialogPhaseOneElements {
  phase1: HTMLDivElement;
  modeGroup: HTMLDivElement;
  rwWarning: HTMLDivElement;
}

interface ShareDialogPhaseTwoElements {
...
interface ShareDialogActionElements {
...
interface CreateShareDialogFlowControllerParams {
  sessionId: string;
...
function createShareDialogPhaseOne(copy: ShareDialogCopy, hasMobileApi: boolean): ShareDialogPhaseOneElements {
...
function createShareDialogPhaseTwo(copy: ShareDialogCopy): ShareDialogPhaseTwoElements {
...
function createShareDialogActions(copy: ShareDialogCopy): ShareDialogActionElements {
...
function createShareDialogFlowController(params: CreateShareDialogFlowControllerParams): ShareDialogFlowController {
  const {
    sessionId,
    overlay,
    copy,
