...
describe('precision cockpit theme contract', () => {
  ...
  it('loads the command studio premium theme after feature styles', () => {
    ...
    expect(commandStudioCss).toContain('studio-mascot-live-float');
    expect(commandStudioCss).toContain('studio-mascot-shell-aura');
    expect(commandStudioCss).toContain('studio-mascot-signal');
