...
const tools: ToolInfo[] = [
  {
    ...
    authPatterns: ['gh auth login', 'gh auth status'],
  },
  ...
  { command: 'cmake', name: 'CMake', description: 'cross-platform build system generation' },
  {
    ...
    authPatterns: ['docker login', 'unauthorized', 'denied: access forbidden'],
  },
  {
    command: 'kubectl',
    name: 'kubectl',
    description: 'Kubernetes cluster management',
    authPatterns: ['unauthorized', "couldn't get current server api group list"],
  },
  {
    command: 'terraform',
    name: 'Terraform',
    description: 'infrastructure as code provisioning',
    authPatterns: ['terraform login', 'no valid credential sources'],
  },
  {
    command: 'aws',
    name: 'AWS CLI',
    description: 'AWS cloud service management',
    authPatterns: ['aws configure', 'unable to locate credentials', 'expiredtoken'],
  },
  {
    command: 'gcloud',
    name: 'Google Cloud CLI',
    description: 'Google Cloud service management',
    authPatterns: ['gcloud auth login', 'unauthenticated'],
  },
  {
    command: 'az',
    name: 'Azure CLI',
    description: 'Azure cloud service management',
    authPatterns: ['az login', "please run 'az login'"],
  },
