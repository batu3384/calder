export const PREFERENCES_TRANSLATION_ENTRIES: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Session defaults, interface behavior, tool health, automation, and safety rules.', 'Oturum varsayılanları, arayüz davranışı, araç sağlığı, otomasyon ve güvenlik kuralları.'],
  ...
  ['Shell layout, rails, and live view behavior', 'Kabuk düzeni, paneller ve Canlı Görünüm davranışı'],
  ['CLI providers and mobile dependency health', 'CLI sağlayıcıları ve mobil bağımlılık sağlığı'],
  ['Project workflows, previews, and background tasks', 'Proje iş akışları, önizlemeler ve arka plan görevleri'],
  ['Context, governance, reviews, and checkpoints', 'Bağlam, yönetişim, incelemeler ve kontrol noktaları'],
