export const CORE_TRANSLATION_ENTRIES_PART_1: ReadonlyArray<readonly [string, string]> = [
  ...
  ['Switch projects, monitor live sessions, and keep your workspace anchored.', 'Projeler arasında geçin, canlı oturumları izleyin ve çalışma alanını sabit tutun.'],
  ['Switch projects and keep live sessions visible.', 'Projeler arasında geçin ve canlı oturumları görünür tutun.'],
  ['Control Rail', 'Kontrol Paneli'],
  ['Workspace Control', 'Çalışma Alanı Kontrolü'],
  ['Sessions, git status, and run activity in one place.', 'Oturum, git durumu ve çalışma etkinliği tek yerde.'],
  ['Approvals, git, and recent activity without leaving the flow.', 'Akışı bozmadan onaylar, git ve son etkinlikler.'],
  ['Workspace', 'Çalışma Alanı'],
  ['Overview', 'Genel Bakış'],
  ['Inspector', 'Denetçi'],
  ['Workspace Pulse', 'Çalışma Alanı Nabzı'],
  ['Run controls, project state, and tools stay separated so the rail stays readable.', 'Çalışma kontrolleri, proje durumu ve araçlar ayrı kalır; panel okunabilirliğini korur.'],
  ...
  ['Worktree status, branches, and safe git actions.', 'Worktree durumu, dallar ve güvenli git işlemleri.'],
  ...
  ['Recent runs, notes, and session timeline.', 'Son çalışmalar, notlar ve oturum zaman çizelgesi.'],
  ...
  ['Claude, Codex, Antigravity, Qwen, and the rest share one health view.', 'Claude, Codex, Antigravity, Qwen ve diğerleri aynı sağlık görünümünü paylaşır.'],
  ['Ready', 'Hazır'],
  ...
  ['A compact view of sessions, message volume, model mix, and hourly activity across this workspace.', 'Bu çalışma alanındaki oturumları, mesaj hacmini, model dağılımını ve saatlik etkinliği kompakt gösterir.'],
  ['Refresh', 'Yenile'],
  ['Loading...', 'Yükleniyor...'],
  ...
  ['Add a project folder, install a supported coding CLI, then open your first agent session from the sidebar.', 'Proje klasörü ekleyin, desteklenen bir kodlama CLI kurun, ardından kenar çubuğundan ilk agent oturumunuzu açın.'],
