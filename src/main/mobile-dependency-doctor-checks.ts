...
async function checkAppium(runner: MobileDoctorCommandRunner): Promise<MobileDependencyCheck> {
...
async function checkBinaryWithVersion(input: CheckBinaryInput): Promise<MobileDependencyCheck> {
