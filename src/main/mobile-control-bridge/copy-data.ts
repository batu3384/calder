...
export const MOBILE_PAGE_COPY: Record<MobileUiLanguage, MobilePageCopy> = {
  en: {
    ...
    heroBody:
      'Enter the one-time code from desktop to unlock your live terminal stream and controls.',
    ...
    readonlyHint:
      'Read-only mode is active. You can watch terminal output but cannot send commands.',
    ...
    wrongPassphraseOrInvalidCode:
      'Secure handshake could not be verified. QR pairing may be stale or expired. Generate a new QR on desktop and try again.',
  ...
  tr: {
    ...
    heroBody:
      'Canlı terminal akışını ve kontrolleri açmak için masaüstündeki tek kullanımlık kodu girin.',
    otpPlaceholder: '000000',
    ...
    switchButton: 'Geç',
    sessionRoutingUnavailable:
      'Güvenli bağlantı hazır olana kadar oturum yönlendirme kullanılamaz.',
    ...
    readonlyHint:
      'Salt okunur mod etkin. Terminal çıktısını izleyebilirsiniz ancak komut gönderemezsiniz.',
    ...
    browserResponsiveButton: 'Responsive',
    browserPhoneButton: 'iPhone 14',
    browserInspectSelectionNone:
      'Henüz inspect seçimi yok. Inspect modunu açıp bir elemana dokunun.',
    ...
    wrongPassphraseOrInvalidCode:
      'Güvenli el sıkışma doğrulanamadı. QR eşleştirmesi eski veya süresi dolmuş olabilir. Masaüstünde yeni QR üretip tekrar deneyin.',
    ...
    serverMessage: {
      ...
      tooManyPairingAttempts:
        'Çok fazla eşleştirme denemesi yapıldı. Lütfen bekleyip tekrar deneyin.',
      ...
      tooManyAnswerSubmissions:
        'Çok fazla yanıt gönderimi yapıldı. Lütfen bekleyip tekrar deneyin.',
      tooManyChallengeRequests:
        'Çok fazla kimlik doğrulama isteği yapıldı. Lütfen bekleyip tekrar deneyin.',
